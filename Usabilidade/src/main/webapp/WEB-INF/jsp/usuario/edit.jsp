...
<form id="editUsuario_Form" action="${pageContext.request.contextPath}/usuarios" method="post" class="form-horizontal form-layout w600">
    <c:if test="${not empty usuario.id}">
        <input type="hidden" name="usuario.id" value="${usuario.id}" />
        <input type="hidden" name="_method" value="put" />
    </c:if>
    <fieldset style="width: 600px;">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="password" name="usuario.senha" id="usuario.senha" value="${usuario.senha}" class="input-xlarge"/>
            </div>
        </div>
        <div class="control-group">
        ...
        <div class="form-actions">
            <input type="submit" value="<fmt:message key="editar"/>" name="enviar" title="Enviar" class="btn btn-primary" style="float: right"/>
        </div>
    </fieldset>
</form>
