<ul class="breadcrumb">
    ...
    <li>
        <a href="${pageContext.request.contextPath}/teste/${usuarioLogado.teste.id }/editar/passo3">Passo 3</a> <span class="divider">/</span>
    </li>
...
<div class="span10 offset1">
    <ul class="nav nav-tabs" style="margin: 0 auto; width: 97%">
        ...
        <li class="active"><a href="${pageContext.request.contextPath}/teste/${usuarioLogado.teste.id }/editar/passo4">Passo4</a></li>
    </ul>
