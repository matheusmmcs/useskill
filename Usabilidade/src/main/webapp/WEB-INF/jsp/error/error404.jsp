...
<body>
		...
		<%@include file="../decorators/topo.jsp"%>
		<div class="container">
			<div class="row container-row">
				    <div class="span12">
				    	<div class="useskill-datamining">
					    	<div class="usdm-box usdm-error-page">
					    		<h2 class="usdm-box-header">
						    		<fmt:message key="error.server.message" />
					            </h2>
					            <div class="usdm-box-body">
					            
					            	<img class="usdm-error-page-img" src="${pageContext.request.contextPath}/img/error.jpg" />
					            	
					            	<a class="usdm-error-page-link" href="#" onclick="window.history.go(-1); return false;">
							  			<fmt:message key="error.server.back" />
							  		</a>
					            </div>
					        </div>
				        </div>
