(function(capt) {
	capt.webclientCapt = function(settings) {
		capt(document).ready(function() {
							...
							// classe Acao
							function Acao(acao, tempo, url, conteudo, tag,
									tagId, tagClass, tagName, tagValue,
									tagType, posicaoPaginaX, posicaoPaginaY) {
								this.tipoAcao = acao;
								this.tempo = tempo;
								this.url = url;
