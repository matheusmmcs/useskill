...
public class TarefaController {
    ...
    public void saveFluxoIdeal(String dados) {
        System.out.println("Chegou: "+dados);
        Gson gson = new Gson();

        Type collectionType = new TypeToken<Collection<Acao>>() {}.getType();
        Collection<Acao> ints2 = gson.fromJson(dados, collectionType);
        List<Acao> lista = new ArrayList<Acao>(ints2);

        for (Acao acao : lista) {
            System.out.println("Sai: "+acao.getTempo());
        }

        //List<Acao> acoes
        //System.out.println("Tarefa" + idTarefa + idTarefa2);
        //System.out.println("Acoes" + dados);
