...
@NamedQueries({
		...
		@NamedQuery(name = "Convidado.Teste.Count", query = "SELECT count(c.chaveComposta.participante.id) FROM Convidado AS c Where c.realizou is null  And c.chaveComposta.participante.id= :usuario And c.chaveComposta.teste.liberado= true"),
		...
		@NamedQuery(name = "Convidado.TesteVO.Count", query = "SELECT count(c.chaveComposta.participante.id) FROM Convidado AS c Where c.realizou is null  And c.chaveComposta.participante.id= :usuario And c.chaveComposta.teste.liberado= true"),
		@NamedQuery(name = "Convidado.Teste.Participado", query = "SELECT c.chaveComposta.teste FROM Convidado AS c Where c.realizou= true And c.chaveComposta.participante.id= :usuario And c.chaveComposta.teste.liberado= true"),
		@NamedQuery(name = "Convidado.Teste.Participado.Count", query = "SELECT count(c.chaveComposta.participante.id) FROM Convidado AS c Where c.realizou= true  And c.chaveComposta.participante.id= :usuario And c.chaveComposta.teste.liberado= true"),
		...
		@NamedQuery(name = "Convidado.Usuarios.Nao.Convidados.Count", query = "Select count(u.id) From Usuario as u Where u.id not in(SELECT c.chaveComposta.participante FROM Convidado AS c Where c.chaveComposta.teste.id= :teste)"),
		...
		@NamedQuery(name = "Convidado.Usuarios.Convidados.Count", query = "SELECT count(c.chaveComposta.participante.id) FROM Convidado AS c Where c.chaveComposta.teste.id= :teste"),
		@NamedQuery(name = "Convidado.Usuarios.Convidados.Tipo.Count", query = "SELECT new  br.ufpi.models.vo.ConvidadoCount(count(c.chaveComposta.participante.id),c.tipoConvidado) FROM Convidado AS c Where c.chaveComposta.teste.id= :teste GROUP BY c.tipoConvidado"),
		@NamedQuery(name = "Convidado.Usuarios.Convidados.Tipo.Realizaram.Count", query = "SELECT new  br.ufpi.models.vo.ConvidadoCount(count(c.chaveComposta.participante.id),c.tipoConvidado) FROM Convidado AS c Where c.chaveComposta.teste.id= :teste and c.realizou= true GROUP BY c.tipoConvidado"),
		})
