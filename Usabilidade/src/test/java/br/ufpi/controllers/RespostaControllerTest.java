 ...
 * resposta</li> <li>Salvar resposta Caso correto</li> Caso de teste Resposta
 * Alternativa</br> <li>Salvar alternativa de forma coreta</li> <li>Salvar
 * alternativa com id diferente da pergunta passada</li>
 * 
 * @author Cleiton
 */
public class RespostaControllerTest extends AbstractDaoTest {
	...
	public void testSalvarRespostaEscritaSemPassarResposta() {
		...
		try {
			instance.salvarRespostaEscrita(resposta,
					perguntaDoTesteConvidadoLiberadoSubjetiva);
	...
	public void testSalvarRespostaAlternativaCorreta() {
		...
		instance.salvarRespostaAlternativa(alternativaPergunta26,
				perguntaDoTesteConvidadoLiberadoObjetiva);
	...
	public void testSalvarRespostaAlternativaPassandoIdInvalido() {
		...
		try {
			...
			instance.salvarRespostaAlternativa(1l,
					perguntaDoTesteConvidadoLiberadoObjetiva);
		} catch (ValidationException validationException) {
			errors = validationException.getErrors();
		}
		Assert.assertEquals("Alternativa não pertence ao teste",
