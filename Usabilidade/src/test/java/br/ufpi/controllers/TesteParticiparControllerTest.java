...
/**
 * Caso de Teste Negar Participação</br> <li>Caso em que o usuario é convidado
 * para o teste e ele esta liberado</li> <li>Caso em que o usuario é convidado
 * para o teste e ele não esta liberado</li> <li>Caso em que o usuario passa id
 * do Teste Null</li> <li>Caso em que o usuario já realizou o teste e depois
 * tenta negar sua participação</li> Caso de Teste Aceitar Participação</br> <li>
 * Caso em que o usuario é convidado para o teste e ele esta liberado</li> <li>
 * Caso em que o usuario é convidado para o teste e ele não esta liberado</li>
 * <li>Caso em que o usuario passa id do Teste Null</li> <li>Caso em que o
 * usuario já realizou o teste e depois tenta negar sua participação</li>
 * 
 * @author Cleiton
 */
public class TesteParticiparControllerTest extends AbstractDaoTest {
	...
	/**
	 * Test of negar method, of class TesteParticiparController. Caso em que o
	 * usuario é convidado para o teste e ele esta liberado
	 */
	@Test
	public void testNegar() {
		...
		Convidado convidadoDepois = convidadoRepository.find(
				testeConvidadoLiberado, usuarioId);
		Assert.assertFalse(convidadoDepois.isRealizou());
	}

	/**
	 * Test of negar method, of class TesteParticiparController. Caso em que o
	 * usuario é convidado para o teste e ele não esta liberado
	 */
	@Test
	public void testNegarTesteNaoLiberado() {
		System.out.println("negar");
		Convidado convidado = convidadoRepository.find(
				testeConvidadoNaoLiberado, usuarioId);
		Assert.assertNull(convidado.isRealizou());
	...
	public void testNegarUsuarioJaRealizouUmaVez() {
		System.out.println("negar");
		Convidado convidado = convidadoRepository.find(
				testeConvidadoEJaParticipou, usuarioId);
	...
	/**
	 * Test of Aceitar method, of class TesteParticiparController. Caso em que o
	 * usuario é convidado para o teste e ele esta liberado
	 */
	@Test
	...
	/**
	 * Test of negar method, of class TesteParticiparController. Caso em que o
	 * usuario é convidado para o teste e ele não passa id Teste
	 */
	@Test
	...
	/**
	 * Test of negar method, of class TesteParticiparController. Caso em que o
	 * usuario é convidado para o teste e já realizou uma vez
	 */
	@Test
