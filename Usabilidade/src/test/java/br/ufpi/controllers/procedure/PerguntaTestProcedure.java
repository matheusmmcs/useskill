...
public class PerguntaTestProcedure {
	...
	public static Pergunta newInstancePerguntaAlternativa(Teste teste, String texto, int numeroAlternativas, boolean responderFim, String titulo) {
	...
	public static List<Alternativa> newListAlternativas(int numeroAlternativas, Pergunta pergunta) {
